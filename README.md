...
Note: I thought the following git commands would create and update my remote repo with the files in my newly created local repo, but this was not the case. I first had to create an empty repo named react_on_phoenix using the github GUI before the following statement would work properly.
```
